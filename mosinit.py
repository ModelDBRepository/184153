'''
Current clamp demo using Allen Brain's model 471085845.
...
from neuron471085845 import Neuron471085845
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron471085845(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 471085845; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-88.530632019)
        h.fcurrent()
